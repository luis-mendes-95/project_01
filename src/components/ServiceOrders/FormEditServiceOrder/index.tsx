...
const FormEditServiceOrder = () => {
  ...
  const serviceOrderToEdit = serviceOrdersDatabase.filter(
    (serviceOrder: IRegisterServiceOrder) => {
      ...
      <FormAdd onSubmit={handleSubmit(submit)} noValidate>
        ...
        <div className="divLabelAndInput">
          ...
          <select {...register("client")}>
            <option value={serviceOrderToEdit[0].client}>
              {serviceOrderToEdit[0].client}
            </option>

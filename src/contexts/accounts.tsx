...
export const AccountContext = createContext<iAccountProviderFunctions>(
  {} as iAccountProviderFunctions
);
...
export const AccountProvider = ({ children }: iAccountProviderProps) => {
  ...
  const signUp = async (data: IRegisterAccount) => {
    const newAccount = {
  ...
  const login = async (data: IRegisterAccountLogin) => {
